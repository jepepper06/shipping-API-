    ...
    public partial class FirstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShipmentAgencies", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipmentAgencyId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShipmentStates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShipmentStates_ShipmentAgencies_ShipmentAgencyId",
                        column: x => x.ShipmentAgencyId,
                        principalTable: "ShipmentAgencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UsersAddress_Cities_CityId",
                        column: x => x.CityId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ShipmentStateId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_ShipmentStates_ShipmentStateId",
                        column: x => x.ShipmentStateId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transports_Offices_OfficeId",
                        column: x => x.OfficeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_ShipmentStateId",
                table: "Orders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShipmentAgencies_Name",
                table: "ShipmentAgencies",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ShipmentStates_ShipmentAgencyId",
                table: "ShipmentStates",
                column: "ShipmentAgencyId");

            migrationBuilder.CreateIndex(
                name: "IX_Transports_OfficeId",
                table: "Transports",
                column: "OfficeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersData_IdentificationDocument",
                table: "UsersData",
                column: "IdentificationDocument",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UsersData_Name",
                table: "UsersData",
                column: "Name",
                unique: true);
